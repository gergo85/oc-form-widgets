...
class TimePicki extends FormWidgetBase
{
    ...
    {
        $this->addCss('/plugins/indikator/form/formwidgets/timepicki/assets/css/timepicki.css');
        $this->addJs('/plugins/indikator/form/formwidgets/timepicki/assets/js/timepicki.js');
    }
