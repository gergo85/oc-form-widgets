...
class MiniColors extends FormWidgetBase
{
    ...
    {
        $this->addCss('/plugins/indikator/form/formwidgets/minicolors/assets/css/minicolors.css');
        $this->addJs('/plugins/indikator/form/formwidgets/minicolors/assets/js/minicolors.js');
    }
